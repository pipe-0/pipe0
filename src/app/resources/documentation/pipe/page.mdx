...
Each pipe takes one or more input fields and produces one or more output fields. What input fields are 
requied can be cound in the <AppLink linkType="pipeCatalog"> 📓 pipe catalog</AppLink>.

Pipe inputs can be provided by input objects or the outputs of another pipe in the pipeline.
