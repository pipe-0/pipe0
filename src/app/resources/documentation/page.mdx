...
[Pipe0](https://pipe0.com) is framework for data enrichment. If you have some data about a person or company 
...
CRM tht updates itself or a sales copilot helping SDRs prepare for upcoming meetings. Data enrichment 
enables these features but is surprisingly hard to build.

At pipe0, we're on a mission to built the fastest, most extensible data enrichment framework in the world.
...
and gets rid of brittle spaghetti code once and for all.
...
- <AppLink linkType="quickstart">Quickstart</AppLink>
- <AppLink linkType="terminology">Terminology</AppLink>
