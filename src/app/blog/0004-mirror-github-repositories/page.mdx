---
title: Pipe0 | How to Mirror Two Github Repository Controlled by You
date: 2025-04-06
...
# How to Mirror Two Github Repository Controlled by You

Mirroring a GitHub repository can be a helpful trick for:

💾 Backups and redundancy <br />
🧠 Control without maintenance <br />
🎉 Getting around the need for pro plans with some providers (e.g. Vercel) <br />
