...
export function CatalogHeader({
  ...
  return (
    <div className="space-y-8 px-4 py-5 bg-accent border rounded-sm">
      <div>
        <h1 className="text-2xl font-bold text-left">{label}</h1>
        <p className="text-lg text-muted-foreground">{description}</p>
        <div className="flex items-center gap-3">
          <CopyToClipboard value={id} className="mt-5" />
        </div>
      </div>
