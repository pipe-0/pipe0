...
`@pipe0/elements-react` is a React component library that renders the same
configuration forms you see throughout these docs. Embed them in your own
product to let end-users configure pipes and searches without writing any
UI yourself.

<Accordions>
<Accordion title="Example: Work email from LinkedIn URL">
<PipeFormPreview
  pipeId="people:workemail:profileurl:waterfall@1"
  pipeLabel="Work email from LinkedIn URL"
