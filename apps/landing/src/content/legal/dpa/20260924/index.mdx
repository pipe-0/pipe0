...
**Retention.** Run records, synchronous and asynchronous alike: 21 days from creation, then deleted within 24 hours. Sheet data, for the lifetime of the sheet, subject to section 13. Connection credentials, until you delete the connection or your account.
