...
excerpt: Learn how to design consistent data models in PostgreSQL by leveraging naming conventions
tags:
    - Postgres
authors:
    - name: Florian
...
When designing database schemas, adhering to naming conventions has practical benefits. It contributes 
...
in complex schemas and multi-word names. Snake case is a widely accepted standard in PostgreSQL communities
...
PostgreSQL requires you to add names to indexes and constraints. Here, you should use a prefix. Use the prefix `idx_` followed by 
