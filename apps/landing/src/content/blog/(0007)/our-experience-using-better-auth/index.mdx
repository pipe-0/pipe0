---
title: Our Experience Using Better-Auth for Pipe0
date: 2025-04-08
category: Thinking
excerpt: Better-auth is a new authentication framework for TypeScript
highlight: true
authors:
    - name: Florian
      title: Founder
...
of your application, your data, and your users' data. Making the right choice seems unfairly complicated 
...
Our authentication is currently powered by better auth. Before our implementation, we weren't able to 
...
you are using a different backend framework, it is easy to integrate better-auth with it.
...
The npm package also does not have any [provenance](https://docs.npmjs.com/viewing-package-provenance) 
