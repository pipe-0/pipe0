...
Since React executes hooks during hydration, this flicker is usually too fast to notice. If you see a flicker, 
there are two options to make this even faster:

1. In React, use `useLayoutEffect` to execute before paint
